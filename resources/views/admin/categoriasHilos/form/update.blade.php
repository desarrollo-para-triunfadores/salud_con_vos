            ...
            <div class="modal-body">
                ...
                <form id="form-update" action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="update-nombre" name="update-nombre" type="text" maxlength="50" class="form-control" placeholder="Campo requerido" required>
                    </div> 
                    <div class="form-group">
                        <label for="formGroupExampleInput">Descripción:</label>
                        <input id="update-descripcion" name="update-descripcion" type="text" maxlength="140" class="form-control" placeholder="Breve descripcion de no mas de 140 caracteres">
                    </div>                                             

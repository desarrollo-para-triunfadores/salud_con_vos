        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-delete" action="" method="POST" accept-charset="UTF-8">
                    ...
                    <h4 class="box-heading">¡Alerta de acción permanente! ¿Eliminar categoría?</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_delete').click()">Eliminar categoría</button>
            </div>
        </div>
    </div>
</div>
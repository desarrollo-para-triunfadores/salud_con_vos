@extends('admin.partes.index') @section('title') Usuarios registrados @endsection @section('content')
                            ...
                            <div class="container" style="width:auto;">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <p class="pull-left form-text text-muted">
                                            <strong>Información:</strong> seleccione uno o más usuarios para filtrarlos en la lista
                                            de usuarios.</p>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="col-md-4 li_item animated pulse" id="{{$usuario->id}}">
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            ...
                            <img style="width:90px;height:90px" alt="User Image" class="img-circle" src="{{ asset('imagenes/usuarios/sin-logo.png') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="description-block text-center">
                                        ...
                                        <a onclick="abrir_modal_borrar({{$usuario->id}})" title="Eliminar este registro" class="btn btn-social-icon btn-sm btn-danger">
...
@include('admin.usuarios.formulario.create') @include('admin.usuarios.formulario.update') @include('admin.usuarios.formulario.confirmar')

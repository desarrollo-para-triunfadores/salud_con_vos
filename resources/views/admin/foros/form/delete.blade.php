    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Eliminar Hilo</h4>
            </div>
            <div class="modal-body">
                <form id="form-delete" action="" method="POST" accept-charset="UTF-8">
                    <input name="_method" type="hidden" value="DELETE">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <h4 class="box-heading">¡Alerta de acción permanente! ¿Eliminar hilo?</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_delete').click()">Eliminar Hilo</button>
            </div>
        </div>
    </div>
</div>
    ...
    <aside>
        ...
        <div id="recent-posts-5" class="widget widget_recent_entries posts_holder">
            ...
            <ul>
                ...
                <li>
                    <a href="/front_blogs/{{$blog_nuevo->id}}">{{$blog_nuevo->titulo}}</a>
                </li>               
                @endforeach
            </ul>
        </div>
        <div id="tag_cloud-4" class="widget widget_tag_cloud posts_holder">
            ...
            <div class="tagcloud">
                ...
                <a href='/front_blogs?categoria={{$categoria->id}}' class='tag-link-12' title='{{$categoria->hilos_foros->count()}} entradas' style='font-size: 13.25pt;'>{{$categoria->nombre}}</a>          
                @endforeach
            </div>
        </div>
    </aside>
